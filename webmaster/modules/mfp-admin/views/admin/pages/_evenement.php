<table width="100%" border="0" cellspacing="2" cellpadding="4">
  <tr>
    <td class="title"><strong>RUBRIQUE :&nbsp;GRAND SLIDE</strong></td>  
  </tr>
  <tr>
   ...
   <?php if ($this->input->get_post('a')=='insert'){ ?>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="4">
      ...
      <tr>
       ...
       <tr id="wide" style="display:none">
         <td>Grande : (...x300) <span style="color:#F00">* </span></td>
       ...
       <tr id="resume" style="display:none">
         ...
         <td><label for="resume"></label>
           <textarea name="resume" cols="36" rows="4" id="resum" placeholder="100 caractères maximum"></textarea></td>
       </tr>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="4">
      ...
      <tr id="small2">
       ...
       <?php if (($to_update['type_lien'] != 'auto') || ($to_update['type_lien'] != 'aucun')) {
