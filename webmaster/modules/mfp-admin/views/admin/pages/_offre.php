<table width="100%" border="0" cellspacing="2" cellpadding="4">
  <tr>
    <td class="title"><strong>RUBRIQUE :&nbsp;OFFRE etc...</strong></td>  
  </tr>
  <tr>
   ...
   <?php if ($this->input->get_post('a')=='insert'){ ?>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="4">
      ...
      <tr>
       ...
       <tr>
         <td>Du : <span style="color:#F00">*</span></td>
         <td><input name="debut" type="text" id="debut" value="<?php echo date('d/m/Y') ?>" readonly></td>
       </tr>
       <tr>
         <td>Au : <span style="color:#F00">*</span></td>
         <td><input type="text" name="fin" id="datepicker"></td>
       </tr>
  
       <tr>
         <td colspan="2"><label for="debut"></label>
           <label for="fin"></label></td>
         </tr>
       <tr>
    ...
    <?php if ($to_update['type_image'] != 'NULL') {
      ...
      <?php }else{?>
       ...
       <tr>
         <td>Du : <span style="color:#F00">*</span></td>
         <td><input type="text" name="debut" id="debut" value="<?php echo $to_update['debut'] ?>"></td>
       </tr>
       <tr>
         <td>Au : <span style="color:#F00">*</span></td>
         <td><input type="text" name="fin" id="fin" value="<?php echo $to_update['fin'] ?>"></td>
       </tr>
       <tr>
         <td colspan="2">&nbsp;</td>
       </tr>
