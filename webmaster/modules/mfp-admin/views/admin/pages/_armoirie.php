<table width="100%" border="0" cellspacing="2" cellpadding="4">
  <tr>
    <td class="title"><strong>RUBRIQUE :&nbsp;ARMOIRIE</strong></td>  
  </tr>
  <tr>
...
<table width="100%" border="1" cellspacing="2" cellpadding="4" class="content">
  <tr>
   ...
   <?php if ($this->input->get_post('a')=='insert'){ ?>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="4">             
       <tr id="small">
         <td>Armoirie : (196x177) <span style="color:#F00">*</span></td>
      ...
      <input name="action" type="hidden" value="ins">
		...
		<input type="hidden" name="t" id="t" value="<?php echo $this->input->get_post('t') ?>">	
         <input name="type_lien" type="hidden" value="NULL"><input name="type_image" type="hidden" value="small">
      </form>
      <?php }else{?>
