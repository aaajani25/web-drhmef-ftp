<table width="100%" border="0" cellspacing="2" cellpadding="4">
  <tr>
    <td class="title"><strong>RUBRIQUE :&nbsp;SLIDES</strong></td>  
  </tr>
  <tr>
  ...
  <tr>
   ...
   <?php if ($this->input->get_post('a')=='insert'){ ?>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="4">
      ...
      <tr>
        <td width="26%">Lien : <span style="color:#F00">*</span></td>
        <td width="74%">
       ...
       <tr id="small">
         <td>Image : (600x310) <span style="color:#F00">*</span></td>
       ...
       <tr id="resume" style="display:none">
         ...
         <td><label for="resume"></label>
           <input name="resume" type="text" id="resum" style="height:60px" size="38" maxlength="140"></td>
       </tr>
  ...
  <?php } elseif($to_update['type_lien'] == 'site'  && empty($to_update['id_com'])){?>
       ...
       <tr>
         ...
         <td colspan="2"><label for="titre"></label>
           <textarea name="titre" cols="36" id="titre" required><?php echo $to_update['titre'] ?></textarea></td>
       </tr>
       <?php }?>
       ...
       <tr id="resume">
         ...
         <td colspan="2"><label for="resume"></label>
           <input name="resume" type="text" id="resum" value="<?php echo $to_update['resume'] ?>" style="height:60px" size="38" maxlength="140"></td>
       </tr>
       <?php }?>
       
      <?php if(!empty($to_update['contenu']) && empty($to_update['id_com'])){?>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="4">
        ...
        <?php if($online) {$n=0;
			...
			foreach($online as $on){
				$n=$n+1;			
		?>
        <tr bgcolor="<?php if($n<=5){$bg_article_on = "#F5F5F5";}else{$bg_article_on = "#FFF";} echo $bg_article_on; ?>">
