             ...
             <div align="center">
               <table width="600px" style="border:1px solid #000; background-color:#9FC">
                 <tr>
                   ...
                   <p>Nous accusons réception de votre message en date du <?php echo date('d/m/Y') ?> et vous assurons que votre requete a été bien transmise à notre service competent pour analyse et traitement.</p>
                   </div>
