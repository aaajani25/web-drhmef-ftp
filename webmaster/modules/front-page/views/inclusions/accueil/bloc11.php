...
<div class="textwidget">
 <div id="concours">
     <div class="titre"><strong><span>Procedure d'affectation</span></strong>
        ...
        <div style="margin:5px; background-color:#FFF;">
        <p style="color:black;">
          Vous etes un nouveau agent mis à la disposition du MEF?...<br>
          veuillez consulter la procedure d'affectation 
         <a href="http://drh.finances.gouv.ci/assets/rubriques/_alaune/procedure_aff_mef.jpg" class="read-more  read-more-page-box">Lire la suite</a>
        </p>
        </div>
     </div>
     <?php ?><div class="titre"><!-- <strong><span>Le saviez-vous ?</span></strong> -->
      ...
      <a href="<?php echo $urs; ?>/default/lu_pour_vous" class="read-more  read-more-page-box">Lire la suite</a>
        ...
        <img src="<?php echo base_url() ?>/assets/images/centre_appels.jpg" alt="" width="300" height="450">
        </div>
     </div>
     <?php ?>
</div>
