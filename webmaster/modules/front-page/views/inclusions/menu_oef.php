        ...
        <ul class="sub-menu">
            ...
            <li id="menu-item-80" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-80"><a href="#">PAO DRH</a>
                <ul class="sub-menu">
                  ...
                  <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-499">
                                <a a href="<?php echo site_url(); ?>front-page/navigator/affiche_pdf/pas_drh_2019.pdf">PAO 2019</a>
                  </li>
                  <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-499">
                                <a a href="<?php echo site_url(); ?>front-page/navigator/affiche_pdf/pas_drh_2020.pdf">PAO 2020</a>
                  </li>
                </ul>
            </li>
    ...
    <li id="menu-item-12" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-12">
      ...
      <ul class="sub-menu">
        <li id="menu-item-59" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-59 "><a href="<?php echo $urs; ?>/ethique/ethique_deonto">Ethique et déontologie</a></li>
            ...
            <!-- <li id="menu-item-59" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-59"><a href="<?php echo site_url('front-page/navigator'); ?>/maintenance/pl">Formulaire de plaintes et réclamations</a></li> -->
  ...
  <!--6 SIGFAE-->
   <li id="menu-item-414" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-414">
    ...
    <ul class="sub-menu">
                 ...
                 <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-499">
                    	<a href="<?php echo $urs; ?>/qualite/qualite_ref">Référentiel des engagements de service</a>

                 <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-499">
                    	<a href="<?php echo site_url('front-page/navigator'); ?>/identification/eth">Ecoute client</a>
                        <!-- <a href="<?php echo site_url('front-page/navigator'); ?>/maintenance/qs">Ecoute client</a> -->
                    </li>
            	</ul>
</li>
  ...
  <!--8 CONTACT-->
    ...
    <a href="#" <?php if ($nav_en_cours=='rub8' || $this->uri->segment(3)=='contact') {echo 'id="link_active"'; $nav_en_cours='rub8';} ?>>SERVICES EN LIGNE </a>
         <ul class="sub-menu">
            ...
            <li id="menu-item-79" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-79"><a href="<?php echo site_url(); ?>/front-page/navigator/demande_stage">Demande de stage</a></li>
            <li id="menu-item-79" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-79"><a href="<?php echo site_url(); ?>/front-page/navigator/recrutement">Demande d'avis favorable</a></li>
   ...
   <!--ENA-->
    <li id="menu-item-176" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-176 menu-item-has-children">
      ...
      <a href="#">FAQ</a>
      <ul class="sub-menu">
            <li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65"><a href="<?php echo $urs; ?>/faq/deontologie" >deontologie</a></li>
            <li id="menu-item-80" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-80"><a href="<?php echo $urs; ?>/faq/faq" >Autres questions</a></li>
