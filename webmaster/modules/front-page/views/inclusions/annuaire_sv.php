...
//-->
   ...
   <select id="source"  name="site" style="width:100%"  onchange="MM_jumpMenu('window.open()',this,0)">             
...
<option value=""  >Intérieur et Sécurité</option>
...
<option value="http://www.environnement.gouv.ci/"  >Environnement, Sal. Urb. et Dév. Dur.</option>
...
<option value="http://www.education-ci.org/intro/"  >Education Nat. et Enseignement Tech.</option>

<option value="http://www.commerce.gouv.ci/"  >Commerce</option>

<option value="http://www.fonctionpublique.egouv.ci/"  >Fonction Publique et Mod. Administration </option>
...
<option value="http://www.famille.gouv.ci"  >Solidarité., Famille, Femme et Enfant </option>

<option value="http://www.culture.gouv.ci"  >Culture et Francophonie</option>

<option value="http://www.telecom.gouv.ci/main.php"  >Poste Techno. de l’Infor. et Comm.</option>

<option value="http://www.sport.gouv.ci/"  > Sports et Loisirs </option>
...
<option value="http/budget.gouv.ci/fr/accueil"  >Budget </option>
	...
	<br>
		...
		<div class="">
            ...
            <form action="" method="post" name="form3" target="_blank" id="form3">	
					<select id="source2" style="width:100%"  onchange="MM_jumpMenu('window.open()',this,0)">
						<option value="" selected="selected">Sites des Ambassades</option>
