...
<!--            4 DEMANDE D'ACTE-->
           ...
           <li id="menu-item-12" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-12">
            ...
            <?php if($this->session->userdata('matricule')=='385186P'): ?>
            <!--7 statistiques-->
            <li id="menu-item-12" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-12">
                <a href="#"
                   >MES STATISTIQUES&nbsp;&nbsp;
                ...
                <ul class="sub-menu">
                    ...
                    <li id="menu-item-80" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-80">
                        <a href="<?php echo $link . '/stat_servicesignes/actes' ?>">Demandes Actes</a>
                    </li>
                    <li id="menu-item-80" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-80">
                        <a href="<?php echo $link . '/stat_servicesignes/plaintes'?>">Plaintes et Réclamations</a>
                    </li>
                    <li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65">
                        <a href="<?php echo $link . '/stat_servicesignes/stages' ?>">Stages</a>
                    </li>
                    <li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65">
                        <a href="<?php echo $link . '/stat_servicesignes/avf' ?>" target="_blank">Avis favorables</a>
                    </li>

                    <li id="menu-item-80" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-80">
                        <a href="<?php echo $link . '/stat_servicesignes/#'; ?>">Ecrire au DRH</a>
                    </li>
                </ul>
