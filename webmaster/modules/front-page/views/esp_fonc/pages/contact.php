	...
	<table width="100%" border="0" align="center" cellpadding="4" cellspacing="5">
	  <tr valign="middle">
	    <td>
		  ...
		  <tr>
		    <td colspan="2"><input type="text" name="nom_prenoms" class="champ_de_saisie" required id="nom_prenoms" value="<?php echo $this->session->userdata('nom') ?>"></td>
		  </tr>
		    ...
		    <td>
		      <fieldset>
		        <img src="<?php echo base_url('assets/css/form-icones/mail_v.png') ?>" alt="sbx">
		          Adresse Electronique<span style="color: #F00">*</span>
					</fieldset>
				</td>
		  </tr>
			<tr>
		  ...
		  <tr>
		    <td>
		      <fieldset>
		       ...
		       Objet<span style="color: #F00">*</span></fieldset>
				</td>
		 </tr>
	   <tr>
...
<div class="panel-grid-cell" id="pgcx-7-1-2">
    ...
    <!--<div class="page-box page-box--block post-7 page type-page status-publish hentry photo"> <span style="text-align:left;">-->
   <table width="100%" border="0" align="center" cellpadding="4" cellspacing="5">
    <tr>
      <td>
		  <fieldset>
			<img src="<?php echo base_url('assets/css/form-icones/dialog_msg_v.png') ?>" alt="sbx">
			 Message<span style="color: #F00">*</span>
		  </fieldset>
	   </td>
    </tr>
    <tr>
